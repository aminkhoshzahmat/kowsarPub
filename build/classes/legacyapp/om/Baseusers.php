...
abstract class Baseusers extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the user_family field.
     * @var        string
     */
    protected $user_family;
    ...
    /**
     * Get the [user_family] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [user_family] column.
     *
     * @param  string $v new value
     * @return users The current object (for fluent API support)
     */
    public function setUserFamily($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->user_family !== $v) {
            $this->user_family = $v;
            $this->modifiedColumns[] = usersPeer::USER_FAMILY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->user_family = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = usersPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(usersPeer::USER_FAMILY)) {
            $modifiedColumns[':p' . $index++]  = '`user_family`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`user_name`':
                        ...
                        break;
                    case '`user_family`':
                        $stmt->bindValue($identifier, $this->user_family, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setUserFamily($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(usersPeer::USER_FAMILY)) $criteria->add(usersPeer::USER_FAMILY, $this->user_family);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUserFamily($this->getUserFamily());
        if ($makeNew) {
            $copyObj->setNew(true);
