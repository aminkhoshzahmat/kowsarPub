...
abstract class BaseusersPeer
{
    ...
    /** the column name for the user_family field */
    const USER_FAMILY = 'users.user_family';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('UserId', 'UserName', 'UserFamily', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'userName', 'userFamily', ),
        BasePeer::TYPE_COLNAME => array (usersPeer::USER_ID, usersPeer::USER_NAME, usersPeer::USER_FAMILY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'USER_NAME', 'USER_FAMILY', ),
        BasePeer::TYPE_FIELDNAME => array ('user_id', 'user_name', 'user_family', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'UserName' => 1, 'UserFamily' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'userName' => 1, 'userFamily' => 2, ),
        BasePeer::TYPE_COLNAME => array (usersPeer::USER_ID => 0, usersPeer::USER_NAME => 1, usersPeer::USER_FAMILY => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'USER_NAME' => 1, 'USER_FAMILY' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'user_name' => 1, 'user_family' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(usersPeer::USER_NAME);
            $criteria->addSelectColumn(usersPeer::USER_FAMILY);
        } else {
            $criteria->addSelectColumn($alias . '.user_id');
            $criteria->addSelectColumn($alias . '.user_name');
            $criteria->addSelectColumn($alias . '.user_family');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(usersPeer::USER_ID) && $criteria->keyContainsValue(usersPeer::USER_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(usersPeer::USER_ID);
            $value = $criteria->remove(usersPeer::USER_ID);
            if ($value) {
                $selectCriteria->add(usersPeer::USER_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(usersPeer::USER_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(usersPeer::DATABASE_NAME);
        $criteria->add(usersPeer::USER_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(usersPeer::DATABASE_NAME);
            $criteria->add(usersPeer::USER_ID, $pks, Criteria::IN);
