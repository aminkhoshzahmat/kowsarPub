...
class usersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'legacyapp.map.usersTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('user_name', 'UserName', 'VARCHAR', true, 30, null);
        $this->addColumn('user_family', 'UserFamily', 'VARCHAR', false, 40, null);
        // validators
    } // initialize()
